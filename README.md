...
**가격과 국내 유통 여부도 다루지 않는다** ([ADR-0022](docs/decisions/0022-drop-availability-and-price.md)).
쇼핑몰 데이터는 입점 계약으로만 얻을 수 있고, 공개 API는 모두 닫혔다. 이 도구의 목적은
구매처 안내가 아니라 **판단을 돕는 것**이다.
